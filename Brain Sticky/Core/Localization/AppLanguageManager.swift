...
public enum LocalizedKey {
    ...
    var chineseValue: String {
        ...
        case .hapticsHeader: return "触觉震动"
        ...
        case .hapticsFeedback: return "触觉震动 (Haptics)"
    ...
    var englishValue: String {
        ...
        case .hapticsHeader: return "Haptics"
        ...
        case .hapticsFeedback: return "Haptic Vibration (Haptics)"
